  ...
  return (
    <section className="px-margin-mobile md:px-margin-desktop py-20 max-w-container-max mx-auto">
      <div className="text-center mb-16">
        <h2 className="font-headline-lg text-headline-lg text-on-surface uppercase tracking-tight mb-2">{t.featuresSectionTitle}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-1 md:auto-rows-[minmax(220px,auto)] max-w-5xl mx-auto">
        <div className="md:col-span-2 glass-panel p-3 md:p-2 flex flex-col justify-end relative overflow-hidden group border border-outline-variant hover:border-primary-container/50 transition-colors">
          ...
          <div className="relative z-10">
            <div className="w-12 h-8 bg-surface border border-outline-variant flex items-center justify-center text-on-surface mb-3">
              <Users size={16} />
            </div>
        ...
        <div className="glass-panel p-3 flex flex-col justify-end relative overflow-hidden border border-outline-variant hover:border-primary-container/50 transition-colors">
          <div className="relative z-10">
            <div className="w-12 h-8 bg-surface border border-outline-variant flex items-center justify-center text-on-surface mb-3">
              <Sword size={16} />
            </div>
        ...
        <div className="md:col-span-2 glass-panel p-3 md:p-2 flex flex-col justify-end relative overflow-hidden group border border-primary-container/30 bg-primary-container/5 hover:border-primary-container transition-colors">
          ...
          <div className="relative z-10">
            <div className="w-12 h-8 bg-primary-container/20 border border-primary-container flex items-center justify-center text-primary-container mb-3 shadow-[0_0_15px_rgba(255,215,0,0.2)]">
              <Activity size={16} />
            </div>
