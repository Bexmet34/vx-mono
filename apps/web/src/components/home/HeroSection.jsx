    ...
    <section className="relative px-margin-mobile md:px-margin-desktop py-20 max-w-container-max mx-auto text-center flex flex-col items-center">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full sm:w-auto bg-transparent border border-on-surface/20 text-on-surface hover:bg-on-surface/10 px-8 py-4 font-label-bold text-label-bold uppercase tracking-widest transition-all duration-300 active:scale-95 rounded-sm flex items-center justify-center gap-2"
        >
