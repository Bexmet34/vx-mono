...
export const BUTTON_DATA = {
  name: {
    ...
    shortLabel: { tr: 'İsim Değiştir', en: 'Rename' },
    emojiName: 'editt',
    fallbackEmoji: '✏️',
    color: '#ffffff',
    icon: (color = '#ffffff') => (
  ...
  limit: {
    ...
    shortLabel: { tr: 'Kullanıcı Limiti', en: 'User Limit' },
    emojiName: 'userss',
    fallbackEmoji: '👥',
    color: '#ffffff',
    icon: (color = '#ffffff') => (
  ...
  waiting_room: {
    ...
    shortLabel: { tr: 'Bekleme Odası', en: 'Waiting Room' },
    emojiName: 'clockk',
    fallbackEmoji: '⏳',
    color: '#facc15',
    icon: (color = '#facc15') => (
  ...
  chat: {
    ...
    shortLabel: { tr: 'Metin Kanalı', en: 'Text Chat' },
    emojiName: 'chatt',
    fallbackEmoji: '💬',
    color: '#ffffff',
    icon: (color = '#ffffff') => (
  ...
  trusted: {
    ...
    shortLabel: { tr: 'Güvenilir Ekle', en: 'Add Trusted' },
    emojiName: 'userpluss',
    fallbackEmoji: '✅',
    color: '#22c55e',
    icon: (color = '#22c55e') => (
  ...
  untrusted: {
    ...
    shortLabel: { tr: 'Güvensiz Ekle', en: 'Add Untrust' },
  ...
  invite: {
    ...
    shortLabel: { tr: 'Davet Et', en: 'Invite' },
    emojiName: 'phonee',
    fallbackEmoji: '📞',
    color: '#22c55e',
    icon: (color = '#22c55e') => (
  ...
  kick: {
    ...
    shortLabel: { tr: 'Kanaldan At', en: 'Kick' },
  ...
  region: {
    ...
    shortLabel: { tr: 'Sunucu Bölgesi', en: 'Region' },
    emojiName: 'globee',
    fallbackEmoji: '🌐',
    color: '#ffffff',
    icon: (color = '#ffffff') => (
  ...
  block: {
    ...
    shortLabel: { tr: 'Engelle', en: 'Block User' },
    emojiName: 'blockk',
    fallbackEmoji: '🚫',
    color: '#ef4444',
    icon: (color = '#ef4444') => (
  ...
  unblock: {
    ...
    shortLabel: { tr: 'Engel Kaldır', en: 'Unblock' },
  ...
  claim: {
    ...
    shortLabel: { tr: 'Sahiplen', en: 'Claim Owner' },
    emojiName: 'crownn',
    fallbackEmoji: '👑',
    color: '#f59e0b',
    icon: (color = '#f59e0b') => (
  ...
  transfer: {
    ...
    shortLabel: { tr: 'Sahipliği Devret', en: 'Transfer' },
  ...
  delete: {
    ...
    shortLabel: { tr: 'Kanalı Sil', en: 'Delete' },
    emojiName: 'deletee',
    fallbackEmoji: '🗑️',
    color: '#ef4444',
    icon: (color = '#ef4444') => (
