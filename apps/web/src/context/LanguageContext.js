...
const en = {
  ...
  // Comparison Section
  compTitle: "Why Choose Veyronix?",
  compSubtitle: "Stop cluttering your Discord server with 6-7 separate bots. Veyronix combines every essential tool into one unified, ultra-fast powerhouse.",
  compOthersTitle: "Traditional Way (Multiple Bots)",
  compOthersDesc: "6+ separate bots, multiple subscriptions, permission chaos, and cluttered servers.",
  compVeyronixTitle: "The Veyronix Way (All-In-One)",
  compVeyronixDesc: "One verified bot, zero bloat, centralized web dashboard, and instant synergy.",
  compBadgeOthers: "Fragmented & Costly",
  compBadgeVeyronix: "Unified & Streamlined",
  compItemTicket: "Ticket & Support Bot",
  compItemTicketDescOthers: "Separate bot needed, distinct prefix, conflicting permissions",
  compItemTicketDescVeyronix: "Native ticket & guild application system directly integrated",
  compItemRegister: "Registration & Auto-Role Bot",
  compItemRegisterDescOthers: "Standalone setup, prone to rate limits, no game sync",
  compItemRegisterDescVeyronix: "Automatic Albion API guild check & dynamic role synchronization",
  compItemGiveaway: "Giveaways & Drop Engine",
  compItemGiveawayDescOthers: "Another external bot with complex commands and separate databases",
  compItemGiveawayDescVeyronix: "Interactive button drops, scheduled giveaways & instant winner rolls",
  compItemKillboard: "Killboard & Stats Bot",
  compItemKillboardDescOthers: "Expensive third-party tiers, delayed feeds, spammy logs",
  compItemKillboardDescVeyronix: "Autonomous daily kill/death/fame visual cards delivered to your channel",
  compItemTempVoice: "Temp Voice / VoiceForge",
  compItemTempVoiceDescOthers: "Slow channel creation, basic command-only controls",
  compItemTempVoiceDescVeyronix: "VoiceForge with 15-button Ultra-HD Retina panel & auto-cleanup",
  compItemParty: "ZvZ & Party Builder Bot",
  compItemPartyDescOthers: "Outdated text embeds, no web synchronization, clunky UI",
  compItemPartyDescVeyronix: "One-click Discord button join, live attendance tracking & web sync",
  compItemDashboard: "Central Web Dashboard",
  compItemDashboardDescOthers: "5+ different login dashboards with separate logins",
  compItemDashboardDescVeyronix: "One unified, sleek dashboard to control everything in seconds",
...
const tr = {
  ...
  compTitle: "Neden Veyronix?",
  compSubtitle: "Sunucunuzu 6-7 farklı botla doldurup yetki karmaşası yaşamaya son verin. Veyronix, ihtiyacınız olan tüm sistemleri tek bir güçlü botta birleştirir.",
  compOthersTitle: "Diğer Botlar (Dağınık Yöntem)",
  compOthersDesc: "6+ ayrı bot, ayrı abonelikler, yetki çakışmaları ve sunucu bot kalabalığı.",
  compVeyronixTitle: "Veyronix (Hepsi Tek Çatıda)",
  compVeyronixDesc: "Tek onaylı bot, sıfır karmaşa, merkezi web paneli ve kesintisiz entegrasyon.",
  compBadgeOthers: "Karmaşık & Masraflı",
  compBadgeVeyronix: "Birleşik & Hızlı",
  compItemTicket: "Ticket & Destek Botu",
  compItemTicketDescOthers: "Ayrı bot kurulumu gerekir, farklı komutlar ve yetki karmaşası",
  compItemTicketDescVeyronix: "Doğrudan entegre ticket ve lonca başvuru yönetim sistemi",
  compItemRegister: "Kayıt & Otomatik Rol Botu",
  compItemRegisterDescOthers: "Harici bot, sınırlı entegrasyon ve oyun verisinden bağımsız",
  compItemRegisterDescVeyronix: "Albion API ile anlık lonca doğrulaması ve otomatik rol senkronizasyonu",
  compItemGiveaway: "Çekiliş & Drop Botu",
  compItemGiveawayDescOthers: "Ayrı bir çekiliş botu ekleme zorunluluğu ve karmaşık komutlar",
  compItemGiveawayDescVeyronix: "Butonlu anlık droplar, zamanlanmış çekilişler ve adil ödül motoru",
  compItemKillboard: "Killboard & İstatistik Botu",
  compItemKillboardDescOthers: "Pahalı harici abonelikler, gecikmeli veriler ve karmaşık raporlar",
  compItemKillboardDescVeyronix: "Otomatik günlük Kill/Death/Fame görsel raporları doğrudan kanalınızda",
  compItemTempVoice: "Geçici Ses Kanalı (VoiceForge)",
  compItemTempVoiceDescOthers: "Yavaş oda açılışı ve sadece komutlarla yönetilen ilkel yapı",
  compItemTempVoiceDescVeyronix: "15 butonlu Ultra-HD VoiceForge kontrol paneli ve otomatik temizlik",
  compItemParty: "ZvZ & Parti Kurucu Botu",
  compItemPartyDescOthers: "Eski tip metin mesajları, web paneli olmayan yetersiz sistem",
  compItemPartyDescVeyronix: "Tek tıkla Discord butonlu katılım, canlı yoklama ve web senkronizasyonu",
  compItemDashboard: "Merkezi Web Kontrol Paneli",
  compItemDashboardDescOthers: "Her bot için ayrı ayrı panellere ve sitelere giriş yapma zorunluluğu",
  compItemDashboardDescVeyronix: "Tüm sunucunuzu tek tıkla yönetebileceğiniz modern Türkçe web paneli",
