...
const BUTTON_CONFIGS = {
  ...
  'lock': { label: { tr: 'KİLİTLE', en: 'LOCK' }, emoji: '🔒', style: 2, custom_id: 'tv_lock' },
  'unlock': { label: { tr: 'KİLİDİ AÇ', en: 'UNLOCK' }, emoji: '🔓', style: 2, custom_id: 'tv_unlock' },
  'hide': { label: { tr: 'GİZLE', en: 'HIDE' }, emoji: '👻', style: 2, custom_id: 'tv_hide' },
  'unhide': { label: { tr: 'GÖRÜNÜR YAP', en: 'UNHIDE' }, emoji: '👁️', style: 2, custom_id: 'tv_unhide' },
