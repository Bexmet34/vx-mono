  ...
  return (
    <main className="container mx-auto px-2 py-8 flex flex-col items-center justify-center max-w-2xl min-h-[70vh]">
        <div className="text-center mb-3">
          ...
          <h1 className="text-[10px] md:text-4xl font-extrabold tracking-tight mb-2">
            Bota Oy Ver, Premium Özellikleri Aç!
          </h1>
          <p className="text-gray-400 text-[10px] max-w-md mx-auto">
        ...
        {status === "unauthenticated" && (
          <div className="w-full max-w-sm bg-[#161a26] border border-gray-800 rounded-xl p-2 mb-3 text-center shadow-xl">
            <ShieldAlert className="w-10 h-7 text-yellow-500 mx-auto mb-2" />
            <h3 className="font-bold text-xs mb-1">Discord Hesabı Gerekli</h3>
            <p className="text-xs text-gray-400 mb-3">
              Oy hakkınızın hesabınızla eşleşmesi için giriş yapmalısınız.
            </p>
            <button
              onClick={() => signIn("discord")}
              className="w-full py-1.5 bg-[#5865F2] hover:bg-[#4752c4] text-white font-bold text-[10px] rounded-lg transition-all shadow-lg flex items-center justify-center gap-2"
            >
        ...
        <div className="w-full max-w-md bg-[#161a26] border border-gray-800 rounded-2xl p-2 mb-3 shadow-2xl flex flex-col items-center">
          ...
          <div className="w-full py-1 text-center text-gray-400 border border-dashed border-gray-800 rounded-xl bg-[#0d0f17]">
            <p className="text-[10px] font-medium text-gray-300">Veyronix Oy Doğrulama Alanı</p>
        ...
        {/* Action Button */}
        {voteSuccess ? (
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-2 text-center max-w-md w-full">
            <CheckCircle2 className="w-12 h-8 text-emerald-400 mx-auto mb-2 animate-bounce" />
            <h3 className="text-[10px] font-bold text-emerald-400 mb-1">Oy Başarıyla Verildi!</h3>
          ...
          <button
            ...
            className={`w-full max-w-md py-1.5.5 px-3 rounded-xl font-extrabold text-xs transition-all shadow-xl flex items-center justify-center gap-2 ${
