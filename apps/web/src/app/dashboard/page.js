  ...
  return (
    <div className="min-h-screen max-w-container-max mx-auto px-4 md:px-margin-desktop pt-4 pb-24">
      ...
      <div className="flex flex-col items-center mb-8 text-center">
        ...
        <div className="flex w-full sm:w-auto p-1.5 rounded-2xl bg-surface-container-high/90 border border-outline-variant/40 backdrop-blur-xl shadow-lg max-w-md mx-auto">
          <button
            onClick={() => setMainTab("servers")}
            className={`flex-1 sm:flex-initial flex items-center justify-center gap-2 px-3.5 sm:px-6 py-2.5 rounded-xl font-label-bold text-xs sm:text-sm uppercase tracking-wider transition-all duration-200 touch-manipulation active:scale-95 ${
              mainTab === "servers"
          ...
          >
            ...
            <span className="truncate">{lang === 'tr' ? 'Sunucularım' : 'My Servers'}</span>
          ...
          >
            ...
            <span className="truncate">{lang === 'tr' ? 'Bireysel Alan' : 'Personal Space'}</span>
