  ...
  return (
    <div className="flex bg-background relative w-full h-[calc(100vh-56px)] overflow-hidden" suppressHydrationWarning>
      ...
      <div className="flex-1 ml-[52px] h-[calc(100vh-56px)] overflow-y-auto custom-scrollbar p-4 pb-20">
        ...
        {activeTab === 'tempvoice' && (
          <TempVoiceTab t={t} lang={lang} settings={settings} setSettings={setSettings} setInitialSettings={setInitialSettings} discordChannels={discordChannels} isPremium={isPremium} guildId={guildId} />
        )}
