        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            <div className="mb-2">
              ...
              <p className="text-[10px] font-body-md text-on-surface-variant mt-2">This image will appear on the top right of your Discord party embeds.</p>
            </div>
          ...
          <div>
             ...
             <div className="bg-[#2b2d31] rounded-sm p-2 border border-[#1e1f22] min-h-[200px] shadow-lg">
