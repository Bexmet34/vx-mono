...
async function testCreateProduct() {
  try {
    const res = await fetch('https://api.shopier.com/v1/products', {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        title: "Test Veyronix Premium",
        price: 1.00,
        currency: "TRY",
        stock: 1,
        description: "Veyronix otomatik premium paketi",
        type: "digital",
        media: [{"type": "image", "url": "https://veyronix.com.tr/icon.png", "placement": 1}]
      })
    });
